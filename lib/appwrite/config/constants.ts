...
export const DATABASE_IDS = {
  ...
  MAIN: process.env.NEXT_PUBLIC_DATABASE_CHAT as string,
  ANALYTICS: process.env.NEXT_PUBLIC_DATABASE_CHAT as string,
  CONTENT: process.env.NEXT_PUBLIC_DATABASE_CHAT as string,
} as const;
...
export const MAIN_COLLECTIONS = {
  CONVERSATIONS: CHAT_TABLES.CONVERSATIONS,
  CONTACTS: CHAT_TABLES.CONTACTS,
  MESSAGES: CHAT_TABLES.MESSAGES,
  TYPING_INDICATORS: CHAT_TABLES.TYPING_INDICATORS,
  PRESENCE: CHAT_TABLES.PRESENCE,
  STORIES: CHAT_TABLES.STORIES,
  POSTS: CHAT_TABLES.POSTS,
  PROFILES: CHAT_TABLES.USERS,
};
...
export const SOCIAL_COLLECTIONS = {
  STORIES: CHAT_TABLES.STORIES,
  STORY_VIEWS: CHAT_TABLES.STORY_VIEWS,
  POSTS: CHAT_TABLES.POSTS,
  FOLLOWS: CHAT_TABLES.FOLLOWS,
};

export const CONTENT_COLLECTIONS = {
  STICKERS: CHAT_TABLES.STICKERS,
  STICKER_PACKS: CHAT_TABLES.STICKER_PACKS,
  USER_STICKERS: CHAT_TABLES.USER_STICKERS,
  GIFS: CHAT_TABLES.GIFS,
  POLLS: CHAT_TABLES.POLLS,
  AR_FILTERS: CHAT_TABLES.AR_FILTERS,
  MEDIA_LIBRARY: CHAT_TABLES.MEDIA_LIBRARY,
};

export const WEB3_COLLECTIONS = {
  WALLETS: CHAT_TABLES.WALLETS,
  TOKEN_HOLDINGS: CHAT_TABLES.TOKEN_HOLDINGS,
};
